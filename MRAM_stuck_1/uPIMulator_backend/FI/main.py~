...
def main(benchmark_name):
    ...
    stuck_bit=0
    mram_addr = get_unique_addresses(f"/home/ebelhadd/stuck_{stuck_bit}/{benchmark_name}/uPIMulator/python_cpp/uPIMulator_backend/FI/mram_accesses/{benchmark_name}.txt")
    ...
    launch_address, offset = read_file(f"/home/ebelhadd/stuck_{stuck_bit}/{benchmark_name}/uPIMulator/python_cpp/uPIMulator_backend/FI/launch_addresses/{benchmark_name}.txt")
    ...
    for i in range(num_of_faults):
        ...
        # Set FI Parameters
        set_fi_parameters(address, byte, bit_position, launch_address, stuck_bit)

        log_filename = f"{benchmark_name}_{i}.bin"
        command = (
            f"/home/ebelhadd/stuck_{stuck_bit}/{benchmark_name}/uPIMulator/python_cpp/uPIMulator_backend/build/src/uPIMulator "
            f"--benchmark {benchmark_name} --num_tasklets 16 "
            f"--bindir /home/ebelhadd/stuck_{stuck_bit}/{benchmark_name}/uPIMulator/python_cpp/uPIMulator_frontend/bin/1_dpus/ "
